...
\title{Typografie a publikování\,\textbf{--}\,1. projekt}
\author{Jakub Vaňo \\ \href{mailto:xvanoj00@stud.fit.vutbr.cz}{xvanoj00@stud.fit.vutbr.cz}}
\date{}
...
\begin{quotation}
    Čím více \textit{druhů}, \textbf{řezů}, {\huge velikostí}, \textcolor{blue}{barev} písma a jiných \textcolor{red}{\scshape efektů} \underline{použijeme}, tím \textcolor{orange}{profesionálněji} bude 
    {\fontfamily{pzc}\selectfont \Large{dokument}} vypadat. {\tiny Čtenář} tím bude vždy {\Huge \textbf{nadšen!}}
\end{quotation}
\quad {\scshape Tímto pravidlem se \underline{nikdy} nesmíte řídit}.
Příliš časté zvýrazňování textových elementů a změny {\tiny velikosti} písma jsou známkou \textbf{amatérismu} autora a působí {\fontfamily{cmtt}\selectfont velmi rušivě}.
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \textit{vlna} od pana Olšáka\footnote[2]{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{http://petr.olsak.net/ftp/olsak/vlna/}}, který si můžete v rámci projektu vyzkoušet.
